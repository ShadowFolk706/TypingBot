...
# Type Function
def Type(String, wordThink, sentenceThink, dismissal):
...
while True:
    ...
    if aiOrNo == 'N':
        ...
        Type(textToType, wordThinkBool, dissmissalBool)
        ...
        stopSpinner.set()
        spinnerThread.join()
        Type(aiAnswer, wordThinkBool, sentenceThinkBool, dissmissalBool)
